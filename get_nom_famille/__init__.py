...
class InformationExtractor:
    ...
    def normalize_e_accents_comprehensive(self , text):
        ...
        text = re.sub(r'A\s*(accents?\s*)?circonflexe\s*', 'Â', text, flags=re.IGNORECASE)
        text = re.sub(r'E\s*(accents?\s*)?circonflexe\s*', 'Ê', text, flags=re.IGNORECASE)
        text = re.sub(r'I\s*(accents?\s*)?circonflexe\s*', 'Î', text, flags=re.IGNORECASE)
        text = re.sub(r'O\s*(accents?\s*)?circonflexe\s*', 'Ô', text, flags=re.IGNORECASE)
        text = re.sub(r'U\s*(accents?\s*)?circonflexe\s*', 'Û', text, flags=re.IGNORECASE)
        text = re.sub(r'E\s*(accents?\s*)?tr[éeè]ma\s*', 'Ë', text, flags=re.IGNORECASE)
        text = re.sub(r'I\s*(accents?\s*)?tr[éeè]ma\s*', 'Ï', text, flags=re.IGNORECASE)
        text = re.sub(r'U\s*(accents?\s*)?tr[éeè]ma\s*', 'Ü', text, flags=re.IGNORECASE)
        text = re.sub(r'O\s*(accents?\s*)?tr[éeè]ma\s*', 'Ö', text, flags=re.IGNORECASE)
        text = re.sub(r'A\s*(accents?\s*)?tr[éeè]ma\s*', 'Ä', text, flags=re.IGNORECASE)
        text = re.sub(r'Y\s*(accents?\s*)?tr[éeè]ma\s*', 'Ÿ', text, flags=re.IGNORECASE)
        text = re.sub(r'C\s*(accents?\s*)?c[éeè]dille\s*', 'Ç', text, flags=re.IGNORECASE)
        return text
